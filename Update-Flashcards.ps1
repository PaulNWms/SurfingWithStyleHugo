function RenderDeck {
    ...
    (Get-Content "static\flashcards\$($deckName)_in.txt") -replace '$', '<br />' | pandoc -f html+tex_math_dollars -t html --mathml --columns=300 -o junk.txt
    ...
    $deck | Out-File -Force -Encoding utf8 "static\flashcards\$($deckName).txt"
}

RenderDeck 'DiscreteMath'
RenderDeck 'MachineLearning'
