import { MIN_TEMPO, AnimationPlayState, MetronomeState, ScheduleState, ui, AnimationName } from "./sm-globals";
...
class Schedule {
    ...
    public metronome: ScheduledMetronome;
    ...
    constructor(eggTimer: EggTimer) {
        ...
        this.metronome = new ScheduledMetronome();
