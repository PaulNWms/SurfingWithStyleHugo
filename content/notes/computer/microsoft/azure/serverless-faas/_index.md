...
tags:
  - "#Azure"
---
- [Azure Functions](/notes/computer/microsoft/azure/az-204/azure-functions) are the most basic of compute tasks. Does one function then dies until next time it is called.
